...
const Immunodot = ({ 
  ...
  subCategoryTitle = "Immunodot",
  contentSections = [
    {
      id: 1,
      title: "Part No. 1102-60 - ImmuGlo ANA HEp-2 Cells IFA Kit",
      hasDetailButton: false
    },
    {
      id: 2,
      title: "Part No. 1103-240 - ImmuGlo ANA HEp-2 Cells IFA Kit",
      hasDetailButton: false
    },
    {
      id: 3,
      title: "Part No. 1103-525 - ImmuGlo ANA HEp-2 Cells IFA Kit",
      hasDetailButton: false
    },
    {
      id: 4,
      title: "Part No. 1106 - ImmuGlo anti-nDNA IFA Kit",
      hasDetailButton: false
    },
    {
      id: 5,
      title: "Part No. 1106-6 - ImmuGlo anti-nDNA IFA Kit",
      hasDetailButton: false
    },
  ]
}) => {
