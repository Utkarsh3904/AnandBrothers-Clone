...
const Hplckits = ({ 
  ...
  contentSections = [
    ...
    {
      id: 5,
      title: "Part No. 17000 - ClinRep® Complete Kit for Porphyrins in Urine (Differentiated)",
      hasDetailButton: false
    },
    {
      id: 6,
      title: "Part No. 17200 - ClinRep® Complete Kit for 5-Aminolevulinic Acid and Porphobilinogene in Urine",
      hasDetailButton: false
    }
  ]
}) => {
