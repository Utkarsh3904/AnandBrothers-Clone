...
const CustomProductPage = ({ 
  ...
  subCategoryTitle = "Virology",
  contentSections = [
    {
      id: 1,
      title: "Part No. MEAG0330 - Measles Virus IgG Elisa Kit",
      hasDetailButton: false
    },
    {
      id: 2,
      title: "Part No. MEAM0330 - Measles Virus IgM Elisa Kit",
      hasDetailButton: false
    },
    {
      id: 3,
      title: "Part No. MUMG0340 - Mumps Virus IgG Elisa Kit",
      hasDetailButton: false
    },
    {
      id: 4,
      title: "Part No. MUMM0340 - Mumps Virus IgM Elisa Kit",
      hasDetailButton: false
    },
    {
      id: 5,
      title: "Part No. EBVM0150 - EBV-VCA IgM Elisa Kit",
      hasDetailButton: false
    },
  ]
}) => {
