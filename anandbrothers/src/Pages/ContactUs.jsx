...
export default function ContactUs() {
    return (
      ...
      <div className="max-w-4xl mx-auto">
        {/* Title */}
        <h1 className="text-5xl font-bold text-gray-800 my-7 text-center">
         Contact Us
        </h1>
            ...
            <div className="max-w-6xl mx-auto sm:px-6 lg:px-12">
                <div className="mt-2 overflow-hidden">
                    <div className="grid grid-cols-1 md:grid-cols-2">
                        <div className="p-6 mr-2 bg-gray-100 sm:rounded-xl">
                        ...
                        <form className="p-6 flex flex-col justify-center">
                            ...
                            <button
                                type="submit"
                                className="md:w-32  bg-blue-800 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-4 hover:bg-blue-700 transition ease-in-out duration-300 hover:scale-103"
                            >
                                Submit
                            </button>
                        </form>
