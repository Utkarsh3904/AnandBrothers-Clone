...
const Gastroenterology = ({ 
  breadcrumbItems = [
    ...
    { label: "Gastroenterology", current: true }
  ],
  ...
  {
    id: 1,
    title: "Part No. 9069 - Calprest NG Elisa Kit",
    description: "",
    hasDetailButton: false
  },
  {
    id: 2,
    title: "Part No. 9062 - Stool Device for Calprest (EASYCAL)",
    description: "",
    hasDetailButton: false
  },
  {
    id: 3,
    title: "Part No. 9191xt - Calfast XT Kit",
    description: "",
    hasDetailButton: false
  },
  {
    id: 4,
    title: "Part No. 9191XT-SP - Calfast XT Starter Pack [CalFast Reader + CalFast XT- 1 Kit (20 T)]",
    description: "",
    hasDetailButton: false
  }
]
