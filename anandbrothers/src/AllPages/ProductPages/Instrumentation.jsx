...
const CustomProductPage = ({ 
  breadcrumbItems = [
    ...
    { label: "Instrumentation", current: true }
  ],
  categoryTitle = "Instrumentation",
  //subCategoryTitle = "Controls",
  contentSections = 
  [
    {
  id: 1,  // Update this ID to be unique within your dataset
  title: "Premier Hb9210 TM – The Premier Choice for HbA1c Testing",
  description: "Our patented boronate affinity methodology offers you accurate & precise results, virtually free from interference, in a rapid & highly scalable package.",
